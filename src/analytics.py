...
def compute_moran_global(
    ...
    logger.info("Calculando Índice de Moran Global")
...
def compute_moran_local(
    ...
    logger.info("Calculando Índice de Moran Local (LISA)")
...
def build_spatial_weights(
    ...
    neighbors: dict[int, set[int]] = {i: set() for i in range(len(h3_indices))}
